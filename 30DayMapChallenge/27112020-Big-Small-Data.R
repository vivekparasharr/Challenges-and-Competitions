...
elevation1 = raster::raster('C:\\Users\\vivek\\Downloads\\mt-everest\\N27E086.hgt')
elevation2 = raster::raster('C:\\Users\\vivek\\Downloads\\mt-everest\\N27E087.hgt')
elevation3 = raster::raster('C:\\Users\\vivek\\Downloads\\mt-everest\\N28E086.hgt')
elevation4 = raster::raster('C:\\Users\\vivek\\Downloads\\mt-everest\\N28E087.hgt')

zion_elevation = raster::merge(elevation1,elevation2,elevation3,elevation4)
...
zion_r = raster::raster("C:\\Users\\vivek\\Downloads\\mt-everest\\LC08_L1TP_140041_20201114_20201119_01_T1_B4.TIF")
zion_g = raster::raster("C:\\Users\\vivek\\Downloads\\mt-everest\\LC08_L1TP_140041_20201114_20201119_01_T1_B3.TIF")
zion_b = raster::raster("C:\\Users\\vivek\\Downloads\\mt-everest\\LC08_L1TP_140041_20201114_20201119_01_T1_B2.TIF")
...
bottom_left = c(y=86.877222, x=27.935)
top_right   = c(y=86.9625, x=28.023611)
...
plot_3d(zion_rgb_contrast, zionel_matrix, windowsize = c(550,450), zscale = 30, shadowdepth = 'auto',
        zoom=.70, phi=45,theta=-45,fov=0, background = "#F2E1D0", shadowcolor = "#523E2B", baseshape="circle")
render_snapshot(title_text = "Mt.Everest, Nepal | Imagery: Landsat 8 | DEM: 30m SRTM",
                title_offset = c(8,15),
                title_size = 22,   title_font = 'Times', title_position = 'northwest',
                title_bar_color = "#1f5214", title_color = "white", title_bar_alpha = 0.5,)

# The static snapshot above is nice, but 3D is best seen in motion, 
# so let’s create a movie of us rotating around the scene.
# We’ll move the camera with render_camera(), and generate 1440 frames 
# with render_snapshot(). At 60 frames per second, this will generate a 
# 24 second video. You can do this via the av package, but I’m going to 
# call ffmpeg directly via a system() call, since the output of av doesn’t
# seem to play nicely with embeddable web videos (for some reason).
angles= seq(0,360,length.out = 1441)[-1]
for(i in 1:1440) {
  render_camera(theta=-45+angles[i])
  render_snapshot(filename = sprintf("zionpark%i.png", i), 
                  title_text = "Mt.Everest, Nepal | Imagery: Landsat 8 | DEM: 30m SRTM",
                  title_offset = c(8,15),
                  title_size = 22,   title_font = 'Times', title_position = 'northwest',
                  title_bar_color = "#1f5214", title_color = "white", title_bar_alpha = 0.5,)
}

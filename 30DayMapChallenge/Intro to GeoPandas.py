...
import os
os.getcwd()
os.chdir('/Users/vivekparashar/Documents/GitHub/30DayMapChallenge/')
...
# Import map of India
map_india=gpd.read_file('/Users/vivekparashar/Documents/GitHub/30DayMapChallenge/Maps/India/Igismap/Indian_States.shp')
map_india=map_india.to_crs(crs='epsg:4326')
map_india.head()

# Import map of Rivers
map=gpd.read_file('/Users/vivekparashar/Documents/GitHub/30DayMapChallenge/Maps/IND_wat/IND_water_lines_dcw.shp')
